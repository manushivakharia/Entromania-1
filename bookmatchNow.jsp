			...
			<div class=container>
				<div class=row>
					<div class=contact_form>
						...
						<form action="<%=request.getContextPath()%>/ticketCo" method="post" name=contact class="formcontact clearfix">
							...
							<div class=form-group>
								<input type=text class=form-control name="number of Tickets" placeholder=No_of_Tickets
									required=""
									data-parsley-required-message="Number of Tickets">
							</div>
